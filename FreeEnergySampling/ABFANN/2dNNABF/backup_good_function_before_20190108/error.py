...
noNN      = readData(sys.argv[2]) # Force_data: ABF without NN
noNNnoABF = readData(sys.argv[3]) # Force_data: without ABF and without NN 
NN        = readData(sys.argv[4]) # Force_data: ABF with NN
